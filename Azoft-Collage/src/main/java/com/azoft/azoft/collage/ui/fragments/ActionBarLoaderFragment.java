...
import com.azoft.azoft.collage.ui.activities.phone.CollageActivity;
...
public abstract class ActionBarLoaderFragment extends LoaderFragment {
    ...
    public void onAttach(final Activity activity) {
        ...
        if (!(activity instanceof CollageAuthActivity)) {
            throw new IllegalStateException("This fragment should be used only with CollageActivity");
        }
    }

    public CollageAuthActivity getActionBarActivity() {
        return (CollageAuthActivity) getActivity();
    }
}