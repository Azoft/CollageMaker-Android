...
import com.redmadrobot.azoft.collage.utils.MediaUtils;
...
public class CollagePreviewCreatorLoader extends DataAsyncTaskLibLoader<String> {
	...
	protected String performLoad() throws Exception {
		final Map<CollageRegion, CollageRegionData> collageDataMap = new HashMap<CollageRegion, CollageRegionData>();
