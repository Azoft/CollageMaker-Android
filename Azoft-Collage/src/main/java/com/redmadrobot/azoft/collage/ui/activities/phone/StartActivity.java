...
import com.redmadrobot.azoft.collage.ui.fragments.CollageSelectionFragment;
 ...
 * @author MiG35
 */
public class StartActivity extends CollageActivity {
	...
	protected void onCreate(final Bundle savedInstanceState) {
		...
		mCurrentUserButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(final View v) {
				startActivityForResult(new Intent(StartActivity.this, UserSelectionActivity.class), USER_SELECTION_REQUEST_CODE);
			}
		});
	...
	private void openCollageBuilder(final User currentUser, final Collage collage) {
		startActivity(new Intent(this, CollageBuilderActivity.class).putExtra(CollageBuilderActivity.EXTRA_USER, currentUser)
